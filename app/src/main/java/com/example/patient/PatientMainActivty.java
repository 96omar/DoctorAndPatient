...
public class PatientMainActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_main_activty);
        CardView card1 = (CardView) findViewById(R.id.p_booking);
        CardView card2 = (CardView) findViewById(R.id.p_view_report);
